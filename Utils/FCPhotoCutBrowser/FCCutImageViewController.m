...
#import "FCCutImageViewController.h"

#define BOUNDCE_DURATION 0.3f

@interface FCCutImageViewController ()
...
@implementation FCCutImageViewController
...
- (void)initControlBtn {
    ...
    [confirmBtn setTitle:NSLocalizedString(@"OK", @"") forState:UIControlStateNormal];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(FCCutImageViewControllerDelegate)]) {
