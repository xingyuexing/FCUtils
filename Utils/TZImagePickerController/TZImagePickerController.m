...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:(41/255.0) green:(132/255.0) blue:(214/255.0) alpha:1.0];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(41/255.0) green:(132/255.0) blue:(214/255.0) alpha:0.5];
    ...
    textAttrs[NSForegroundColorAttributeName] = [UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1.0];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
        ...
        [backButton setImage:[UIImage imageNamedFromMyBundle:@"arrow.png"] forState:UIControlStateNormal];
...
//        [weakSelf.albumArr replaceObjectAtIndex:indexPath.row withObject:model];
        if (indexPath.row < weakSelf.albumArr.count) {
            [weakSelf.albumArr replaceObjectAtIndex:indexPath.row withObject:model];
        }
    }];
