...
- (void)configCustomNaviBar {
    ...
    [_backButton setImage:[UIImage imageNamedFromMyBundle:@"arrow.png"] forState:UIControlStateNormal];
...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[UIImage imageNamedFromMyBundle:@""] forState:UIControlStateSelected];
